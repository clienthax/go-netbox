...
func (o *VirtualizationInterfacesGraphsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewVirtualizationInterfacesGraphsOK()
...
func NewVirtualizationInterfacesGraphsOK() *VirtualizationInterfacesGraphsOK {
	return &VirtualizationInterfacesGraphsOK{}
}
...
func (o *VirtualizationInterfacesGraphsOK) Error() string {
	return fmt.Sprintf("[GET /virtualization/interfaces/{id}/graphs/][%d] virtualizationInterfacesGraphsOK  %+v", 200, o.Payload)
}

func (o *VirtualizationInterfacesGraphsOK) GetPayload() *models.VMInterface {
	return o.Payload
}

func (o *VirtualizationInterfacesGraphsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
